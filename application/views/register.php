		...
		<div class="container container-tight py-4">
			<div class="text-center mb-4">
				<a href="." class="navbar-brand navbar-brand-autodark">
					<img src="<?= base_url() ?>template/static/gundar.png" height="150" alt="">
				</a>
			</div>
			<!-- Flash Message -->
			...
			<?php endif; ?>
			<!-- End Flash Message -->
			<form class="card card-md" action="<?= site_url('register/process') ?>" method="post" autocomplete="off" novalidate>
				<div class="card-body">
					...
					<div class="mb-2">
						...
						<div class="input-group input-group-flat">
							<input type="password" class="form-control" name="password" placeholder="Enter your password" id="myInput" required>
							<span class="input-group-text">
								<a href="#" class="link-secondary" onclick="myFunction()" title="Show password" data-bs-toggle="tooltip">
			...
			<div class="text-center text-secondary mt-3">
				Already have account? <a href="<?= site_url('login') ?>" tabindex="-1">Login</a>
			</div>
