	...
	<div class="container-xl">
		<div class="row g-2 align-items-center">
			<div class="col">
				...
				<h2 class="page-title"> Tahun: <?= $year ?></h2>
			</div>
			<!-- Page title actions -->
					...
					<div id="table-default" class="table-responsive">
						<table class="table table-bordered" id="myTableMain">
							...
							<tbody class="table-tbody">
								<?php if (!empty($results)): // $results berisi data dari tabel 'daftar' 
								?>
									<?php foreach ($results as $i => $daftar): ?>
										<tr>
											...
											<!-- <a
													...
													data-vital='<?= json_encode($daftar, JSON_HEX_APOS); ?>'>
													Update
												</a> -->
											...
											<!-- <a
													...
													data-id-vital="<?= $daftar['daftar_id']; ?>"
													data-bs-toggle="modal"
